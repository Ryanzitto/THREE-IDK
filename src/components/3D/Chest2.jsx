...
Command: npx gltfjsx@6.2.10 public/models/minecraft_chest.glb 
...
export function ChestTeste(props) {
  const group = useRef();
  const { nodes, materials, animations } = useGLTF(
    "models/minecraft_chest copy.glb"
  );
...
useGLTF.preload("models/minecraft_chest copy.glb");
